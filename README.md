# Flea Market App Coachtech
本アプリは、Laravelを用いて構築したフリーマーケットアプリです。

## 概要  
ユーザー認証、商品出品・購入、コメント、チャット、決済連携などの機能を実装した、フリーマーケットアプリケーションです。
...
## 概要補足
本プロジェクトはCOACHTECHプロテストとして、同スクール模擬案件1回目に作成されたフリマアプリケーションに対して、機能追加を行なったものです。
